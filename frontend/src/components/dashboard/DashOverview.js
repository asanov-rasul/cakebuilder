    ...
    <div className={styles.page}>
      ...
      {shop?.subscription_status === 'trial' && trialDaysLeft !== null && (
        <div className={styles.trialBanner}>
          <span>⏳ Free trial ends in <strong>{trialDaysLeft} days</strong></span>
      ...
      {shop?.subscription_status === 'inactive' && (
        <div className={`${styles.trialBanner} ${styles.bannerWarn}`}>
          ⚠️ Your subscription is inactive. Contact support to reactivate.
        </div>
      )}
      ...
      <div className={styles.statsGrid}>
        ...
        <div className={styles.statCard}>
          <div className={styles.statIcon}>💰</div>
          <div className={styles.statNum}>${(stats?.total_revenue ?? 0).toFixed(0)}</div>
          <div className={styles.statLabel}>Total revenue</div>
        </div>
        <div className={styles.statCard}>
          <div className={styles.statIcon}>📈</div>
          <div className={styles.statNum}>${(stats?.revenue_last_30 ?? 0).toFixed(0)}</div>
